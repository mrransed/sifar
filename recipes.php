...
$sql="SELECT rec.id as id,rec.nombre as nombre,
rec.instruciones as instruciones,rec.imagen as imagen 
FROM recetas as rec ";  
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="cd-trainer-text">
                                        ...
                                        <?php
$idRec=$res['id'];
$sql2="SELECT ing.id as idIng,ing.nombre as ingNombre,
ing.cantidad as ingCantidad
FROM ingredientes as ing WHERE ing.recetas_id='$idRec' "; 
...
while($res2=mysqli_fetch_array($query2)){
                                        ...
                                        <ul class="trainer-info">
                                            <li><span>nombre</span><?php
                                    echo $res2['ingNombre'];
                                ?></li>
                                            <li><span>cantidad</span><?php
                                    echo $res2['ingCantidad'];
                                ?></li>
