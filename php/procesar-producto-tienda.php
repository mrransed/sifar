...
if ($con->connect_error) {
    ...
    if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
        ...
        if (copy($ruta_temporal, $carpeta_destino . $nombre_archivo)) {
            ...
            $sql = "INSERT INTO store (nombre, descripcion, imagen, precio) 
                    VALUES ('$nombre', '$descripcion', '$nombre_archivo','$precio')";
...
mysqli_close($con);
header("LOCATION:../cms.php?pag=crud-tienda&var=correct");
?>