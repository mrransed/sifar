            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>HiSTORIAS MUJERES REALES</h2>
                        <div class="bt-option">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cd-trainer-pic">
                                        <img src="img/classes/class-details/<?php echo $res['foto']; ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                ?></h4>
                                        ...
                                        <ul class="trainer-info">
                                            <li><span>Edad</span><?php
                                    echo $res['edad'];
                                ?></li>
                                            <li><span>Peso</span><?php
                                    echo $res['peso'];
                                ?></li>
                                            <li><span>Altura</span><?php
                                    echo $res['altura'];
                                ?></li>
                                            <li><span>Ocupacion</span><?php
                                    echo $res['ocupacion'];
                                ?></li>
                                        </ul>
                                        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="sidebar-option">
                        ...
                        <!-- <div class="so-latest">
                            <h5 class="title">Ultimas noticas</h5>
