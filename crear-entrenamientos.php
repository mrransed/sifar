            ...
            <div class="row" id="login">
                ...
                <div class="col-lg-6">
                    <div class="leave-comment">
                        <form action="php/procesar-entrenamientos.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="number" placeholder="series" name="series" class="btn-m">
                            <input type="number" placeholder="repeticion" name="repeticion" class="btn-m">
